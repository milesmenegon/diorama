...
<head>
  ...
  $(document).ready(function(){
  	var sn = $('#block-menu-menu-sn-links li a');
  	for(i=0; i<=sn.length; i++){
  		$('#block-menu-menu-sn-links li')
  			.eq(i)
  			.addClass($('#block-menu-menu-sn-links li a').eq(i).text());
  	}
  	$('#footer').append("<div id='watermark'></div>");
  	/*var h = $('#container').height();
  	$('body.not-front #watermark').css('top',h-80+'px');*/
  });
  </script>
    ...
    <div id="container">
      ...
      <div id="content">
        	<?php if (!empty($breadcrumb)): ?>
        		<div id="breadcrumb">
        			<?php print $breadcrumb .  ' &raquo; ' .  $node->title; ?> 
        		</div>
        	<?php endif; ?>
          <?php if (!empty($title)): ?>
          		<h1 class="title" id="page-title"><?php print $title; ?></h1>
          <?php endif; ?>
          <?php if (!empty($tabs)): ?><div class="tabs"><ul><?php print $tabs; ?></ul></div><?php endif; ?>
          <?php if (!empty($messages)): print $messages; endif; ?>
          <?php if (!empty($help)): print $help; endif; ?>
          <?php if (!empty($content_top)): print $content_top; endif; ?>
          <?php print $content; ?>
